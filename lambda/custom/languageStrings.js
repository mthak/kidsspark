...
module.exports = {
    en: {
        translation: {
            ...
            LIFE_LINE_MSG: '<voice name="Brian"><lang xml:lang="en-GB"> You have {{lifeLinesLeft}} life lines left. Please answer your current question to continue, or say start new game. Your current question is {{currentQuestion}}</lang></voice>',
    ...
    de: {
        translation: {
            WELCOME_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Willkommen bei Millionaire Monkeys. In diesem Spiel geht es darum, Fragen zu verschiedenen Fähigkeiten zu lösen. Sie erhalten 15 Fragen und 3 Lebenslinien, die Ihnen beim Spielen helfen. Um ein neues Spiel zu starten, können Sie sagen, Sie starten ein neues Spiel, Sie starten eine Gruppe oder Sie spielen in einer Gruppe, Sie erstellen eine neue Gruppe, gefolgt von einem Gruppennamen, oder Sie spielen in einer vorhandenen Gruppe, gefolgt von einem Gruppennamen. Um mehr über die Lebenslinien in diesem Spiel zu erfahren, sagen wir, Lebenslinien. Sagen Sie, um Hilfe zu erhalten, Helfen Sie mir. Also, womit kann ich Ihnen helfen?</lang></voice>',
            WELCOME_BACK_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Willkommen zurück bei Millionaire Monkeys. Um das vorherige Spiel fortzusetzen, sagen Sie, setzen Sie das Spiel fort. Um ein neues Spiel zu starten, sagen Sie Neues Spiel starten. Wenn Sie beispielsweise in einer Gruppe spielen möchten, erstellen Sie eine neue Gruppe, gefolgt von einem Gruppennamen, oder spielen Sie in einer vorhandenen Gruppe, gefolgt von einem Gruppennamen. Sagen Sie, um Hilfe zu erhalten, Helfen Sie mir. Also, womit kann ich Ihnen helfen?</lang></voice>',
            WELCOME_REPROMPT_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Das habe ich nicht verstanden. Womit kann ich dir helfen?</lang></voice>',
            GOODBYE_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Auf Wiedersehen! Danke, dass du Millionaire Monkeys spielst</lang></voice>',
            REFLECTOR_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Sie haben gerade ausgelöst {{intentName}}</lang></voice>',
            FALLBACK_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Entschuldigung, das weiß ich nicht. Bitte versuche es erneut. Wenn Sie eine Frage beantworten, sagen Sie, antworten Sie und dann die Antwort. Um das Spiel zu starten und fortzusetzen, sagen Sie bitte "Neues Spiel starten" oder "Spiel fortsetzen".</lang></voice>',
            ERROR_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Entschuldigung, ich hatte Probleme damit, das zu tun, worum Sie gebeten haben. Bitte versuche es erneut.</lang></voice>',
            CANNOT_BUY_RIGHT_NOW: '<voice name="Hans"><lang xml:lang="de-DE"> Ich glaube nicht, dass wir ein Produkt mit diesem Namen haben. Können Sie es erneut versuchen oder die aktuelle Frage beantworten? {{currentQuestion}}</lang></voice>',
            CANCEL_SUCCESS: '<voice name="Hans"><lang xml:lang="de-DE"> Sie haben Ihre Gleit-Rettungsleine erfolgreich abgebrochen. Bitte fahren Sie fort, Ihre Frage zu beantworten.</lang></voice>',
            NOTHING_TO_CANCEL: '<voice name="Hans"><lang xml:lang="de-DE">Sie haben derzeit kein Abonnement zum Kündigen.</lang></voice>',
            START_QUIZ_MESSAGE: '<voice name="Hans"><lang xml:lang="de-DE"> OKAY. Beginnen wir mit Millionaire Monkeys. </lang></voice>',
            CANNOT_CANCEL_RIGHT_NOW: '<voice name="Hans"><lang xml:lang="de-DE"> Beim Stornieren dieses Kaufs ist ein Problem aufgetreten. Bitte versuchen Sie es später noch einmal oder kontaktieren Sie uns, um Hilfe zu erhalten.</lang></voice>',
            ERROR_QUESTION_FETCH: '<voice name="Hans"><lang xml:lang="de-DE"> Beim Abrufen der Fragen ist ein Fehler aufgetreten. Sagen Sie bitte "Spiel fortsetzen" oder starten Sie ein neues Spiel, um fortzufahren! Oder Bitte versuchen Sie es später noch einmal</lang></voice>',
            QUESTION_BEGIN: '<voice name="Hans"><lang xml:lang="de-DE"> Um die Frage zu beantworten, sagen Sie bitte, Antwort ist, und dann Ihre Antwort . Hier ist Ihre Frage, die jetzt auftaucht. </lang></voice>',
            ALL_QUESTIONS_ANSWERED: '<voice name="Hans"><lang xml:lang="de-DE"> Glückwunsch! Sie haben alle Fragen beantwortet. Gut gemacht!</lang></voice>',
            QUESTIONS_ANSWERED_CORRECTLY: '<voice name="Hans"><lang xml:lang="de-DE"> Das ist die richtige Antwort. </lang></voice>',
            QUESTIONS_ANSWERED_WORNG: '<voice name="Hans"><lang xml:lang="de-DE"> ACH NEIN! Dies ist die falsche Antwort . </lang></voice>',
            NEXT_QUESTION: '<voice name="Hans"><lang xml:lang="de-DE"> Fahren wir mit Ihrer nächsten Frage fort. </lang></voice>',
            QUESTIONS_JUMP: '<voice name="Hans"><lang xml:lang="de-DE"> Sie können Ihre Gleitleine weiterhin kaufen und verwenden. Wenn Sie über diese Frage hinweggleiten möchten, sagen Sie bitte GLIDE life line kaufen. </lang></voice>', 
            QUESTIONS_CANNOT_JUMP: '<voice name="Hans"><lang xml:lang="de-DE"> Leider haben Sie Ihre GLIDE life line schon einmal benutzt. Dieses Spiel ist beendet . </lang></voice>', 
            QUESTIONS_REPROMPT_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Das habe ich nicht verstanden.</lang></voice>' ,
            HELP_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Sie können die Option Fifty Fifty verwenden, um ein paar der richtigen und ein anderes Wrong-Antworten anzuhören. ' 
            ...
            CURRENT_SCORE: '<voice name="Hans"><lang xml:lang="de-DE"> Ihre aktuelle Punktzahl ist {{score}} . </lang></voice>',
            CURRENT_SCORE_ERROR: '<voice name="Hans"><lang xml:lang="de-DE">Bitte setzen Sie das Spiel fort oder starten Sie es, um den Spielstand zu erfahren.</lang></voice>',
            FIFTY_FITY_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Hier sind die beiden Optionen für Ihre Frage. </lang></voice>',
            EXPERT_REVIEW_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Dies ist, was der Experte zu Ihrer Frage zu sagen hat. </lang></voice>',
            REASK_FIFTY_FIFTY_QUESTION: '<voice name="Hans"><lang xml:lang="de-DE">Sie haben Ihre beiden Optionen gehört. Lassen Sie uns versuchen, Ihre aktuelle Frage zu beantworten. {{currentQuestion}}</lang></voice>',
            REASK_EXPERT_REVIEW_QUESTION: '<voice name="Hans"><lang xml:lang="de-DE">Sie haben die Expertenkommentare gehört. Lassen Sie uns versuchen, Ihre aktuelle Frage zu beantworten. {{currentQuestion}}</lang></voice>',
            LIFE_LINE_ERROR_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Entschuldigung, du kannst diese Lebenslinie nur benutzen, wenn dein Spiel läuft. Bitte setze das Spiel fort oder starte ein neues, um deine Lebenslinien zu nutzen. </lang></voice>',
            LIFE_LINE_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Du hast noch {{lifeLinesLeft}} Lebenslinien übrig. Bitte beantworten Sie Ihre aktuelle Frage, um fortzufahren, oder sagen Sie "Neues Spiel starten". Ihre aktuelle Frage lautet {{currentQuestion}}</lang></voice>',
            LIFE_LINE_EXHAUSTED: '<voice name="Hans"><lang xml:lang="de-DE"> Entschuldigung, Sie haben die Lebenslinie {{lifeLineName}} bereits verwendet. Bitte verwenden Sie eine andere Lebensader. Oder beantworten Sie Ihre aktuelle Frage. {{currentQuestion}}</lang></voice>',
            LIFE_LINES_SATUS: '<voice name="Hans"><lang xml:lang="de-DE"> Um über andere Lebenslinien Bescheid zu wissen, geben Sie meinen Lebenslinien- oder Lebenslinienstatus an. {{currentQuestion}}</lang></voice>',
            CURRENT_QUESTION: '<voice name="Hans"><lang xml:lang="de-DE">Hier ist deine aktuelle Frage {{currentQuestion}} </lang></voice>',
            START_GAME_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Um das vorherige Spiel fortzusetzen, sagen Sie, "Spiel fortsetzen", oder um ein neues Spiel zu starten, sagen Sie, "Neues Spiel starten". Wenn Sie Hilfe benötigen, sagen Sie: Helfen Sie mir . Also, bei was kann ich Ihnen helfen?</lang></voice>',
            GAME_RULES_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> In diesem Spiel geht es darum, Fragen zu verschiedenen Fähigkeiten zu lösen. Sie erhalten 15 Fragen und 3 Lebenslinien, die Ihnen beim Spielen helfen. </lang></voice>',
            USE_LIFE_LINES: '<voice name="Hans"><lang xml:lang="de-DE"> Sie können jederzeit Fifty Fifty oder Expert Review oder Buy Glide Life Line verwenden. </lang></voice>',
            RESUME_ERROR_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Es tut uns leid, aber es gibt keine Spiele zum Fortsetzen. Um ein neues Spiel zu starten, sagen Sie Neues Spiel starten. Wenn Sie Hilfe benötigen, sagen Sie: Helfen Sie mir . Also, bei was kann ich Ihnen helfen?</lang></voice>',
            CONSUMABLE_NOT_PURCHASED: '<voice name="Hans"><lang xml:lang="de-DE"> Entschuldigung, Glide Life Line wurde zu diesem Zeitpunkt nicht gekauft. Sie haben eine Frage falsch beantwortet. Sie können sich in diesem aktuellen Spiel nicht weiter bewegen. Um fortzufahren, benötigen Sie eine Gleit-Lebenslinie, andernfalls starten Sie ein neues Spiel. Um das Spiel zu starten, bitte neues Spiel starten. Womit kann ich dir helfen? </lang></voice>',
            THANK_YOU_FOR_BUYING: '<voice name="Hans"><lang xml:lang="de-DE"> Vielen Dank für den Kauf von glide life line. Sie können jetzt über diese falsche Antwort gleiten und die nächste Frage erhalten. Verwenden Sie jetzt Ihre Lebenslinie, um über die aktuelle Frage zu springen. Denken Sie daran, dass Sie nach der Verwendung dieses Lebens Ihre Gleitleine nicht mehr verwenden können. Sie gleiten Lebenslinie angewendet und hier ist Ihre nächste Frage.  {{askQuestion}}  </lang></voice>',
            CAN_NOT_BUY_CONSUMABLE: '<voice name="Hans"><lang xml:lang="de-DE"> Anscheinend können wir derzeit keine Tipps verkaufen. Es tut uns leid. Da Sie diese Lebensader benötigen, um fortzufahren, können wir in diesem aktuellen Spiel keine weiteren Schritte ausführen. Bitte versuchen Sie es erneut oder starten Sie ein neues Spiel. Um das Spiel zu starten, bitte neues Spiel starten. Womit kann ich dir helfen?</lang></voice>',
            DEFAULT_GAME_NAME_MSG: '<voice name="Hans"><lang xml:lang="de-DE"> Bitte sagen Sie, erstellen Sie eine neue Gruppe, um eine Gruppe zum Spielen zu erstellen. Oder sagen Sie, starten Sie ein neues Spiel</lang></voice>',
            ERROR_CREATING_GROUP: '<voice name="Hans"><lang xml:lang="de-DE"> Beim Erstellen der Gruppe ist ein Fehler aufgetreten. Bitte versuchen Sie es mit einem Einzelmodus-Spiel . Um im Einzelmodus zu starten, sagen Sie, bitte "Einzelmodus-Spiel starten". </lang></voice>',
            ERROR_CREATING_GROUP_REPEAT: '<voice name="Hans"><lang xml:lang="de-DE"> Um im Einzelmodus zu starten, sagen Sie, bitte Start single mode game. </lang></voice>',
            GROUP_ALREADY_EXISTS: '<voice name="Hans"><lang xml:lang="de-DE">  Fand diese Gruppe. Wenn Sie eine Gruppe mit einem anderen Namen erstellen möchten. Bitte sagen Sie eine neue Gruppe erstellen. gefolgt vom neuen Gruppennamen. Oder, um in dieser bestehenden Gruppe zu spielen, konkurrieren Sie mit, gefolgt von Gruppenname. </lang></voice>',
            GROUP_ALREADY_EXISTS_REPROMPT: '<voice name="Hans"><lang xml:lang="de-DE"> Bitte sagen Sie, erstellen Sie eine neue Gruppe, gefolgt von einem neuen Gruppennamen </lang></voice>',
            GROUP_NOT_EXISTS: '<voice name="Hans"><lang xml:lang="de-DE"> Vielen Dank, dass Sie eine neue Gruppe für Ihr Spiel erstellt haben. Bitte sagen Sie, um das Spiel zu starten, starten Sie das Spiel. </lang></voice>',
            GROUP_NOT_EXISTS_REPROMPT: '<voice name="Hans"><lang xml:lang="de-DE"> Bitte sagen Sie, starten Sie, das Spiel, um zu spielen.  </lang></voice>',
            RESUME_AFTER_CANCEL_PURCHASE: '<voice name="Hans"><lang xml:lang="de-DE">Um das vorherige Spiel fortzusetzen, sagen Sie "Spiel fortsetzen", oder um ein neues Spiel zu starten, sagen Sie "Neues Spiel starten"</lang></voice>'
        }
    }
}