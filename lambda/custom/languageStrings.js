...
module.exports = {
    ...
    de: {
        translation: {
            ...
            FALLBACK_MSG: '<voice name="Marlene"><lang xml:lang="de-DE"> Entschuldigung, das weiß ich nicht. Bitte versuche es erneut. Wenn Sie eine Frage beantworten, sagen Sie, antworten Sie und dann die Antwort. Um das Spiel zu starten und fortzusetzen, sagen Sie bitte "Neues Spiel starten" oder "Spiel fortsetzen".</lang></voice>',
            ...
            QUESTION_BEGIN: '<voice name="Marlene"><lang xml:lang="de-DE"> Um die Frage zu beantworten, sagen Sie bitte, Antwort ist, und dann Ihre Antwort . Hier ist Ihre Frage, die jetzt auftaucht. </lang></voice>',
            ...
            LIFE_LINE_MSG: '<voice name="Marlene"><lang xml:lang="de-DE"> Du hast noch {{lifeLinesLeft}} Lebenslinien übrig. Bitte beantworten Sie Ihre aktuelle Frage, um fortzufahren, oder sagen Sie "Neues Spiel starten". Ihre aktuelle Frage lautet {{currentQuestion}}</lang></voice>',
