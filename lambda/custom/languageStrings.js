...
module.exports = {
    en: {
        translation: {
            WELCOME_MSG: '<voice name="Brian"><lang xml:lang="en-GB"> Welcome to Millionaire Monkeys. This game is about solving questions on various skills. You will get 15 questions and 3 life lines to help you while playing. To start a new game you can say \'start new game\', to start a group, or, play in a group say, \'create a new group\', or, \'play in existing group\', followed by Group Name.  To hear about the Life Lines in this game, say \'Life Lines\'. For help, say , \'Help me\'. So, What can I help you with?</lang></voice>',
            WELCOME_BACK_MSG: '<voice name="Brian"><lang xml:lang="en-GB"> Welcome back to Millionaire Monkeys. To resume your previous game say \'resume game\'. To start a new game, say \'Start new Game\'. To play in a group say \'create a new group\' .or. \'play in existing group\'. followed by Group Name.  For help, say , \'Help me\'. So, What can I help you with?</lang></voice>',
    ...
    de: {
        translation: {
            WELCOME_MSG: '<voice name="Brian"><lang xml:lang="en-GB"> Willkommen bei Millionaire Monkeys . In diesem Spiel geht es um das Lösen von Fragen zu verschiedenen Fertigkeiten. Sie erhalten 15 Fragen und 3 Lebenslinien, die Ihnen beim Spielen helfen. Um ein neues Spiel zu starten, können Sie "Neues Spiel starten" sagen \', um eine Gruppe zu gründen, oder, um in einer Gruppe zu spielen, sagen Sie \' eine neue Gruppe erstellen \', oder \' in einer vorhandenen Gruppe spielen \', gefolgt von Gruppenname . Um mehr über die Lebenslinien zu erfahren Sagen Sie in diesem Spiel \ "Lebenslinien \" . Um Hilfe zu erhalten, sagen Sie \ "Hilf mir \" . Also, womit kann ich Ihnen helfen?</lang></voice>',
            WELCOME_BACK_MSG: '<voice name="Brian"><lang xml:lang="en-GB"> Willkommen zurück bei Millionaire Monkeys . Um Ihr vorheriges Spiel fortzusetzen, sagen Sie "Spiel fortsetzen". Um ein neues Spiel zu starten, sagen Sie "Neues Spiel starten". Um in einer Gruppe zu spielen, sagen Sie "Erstellen" Eine neue Gruppe \'. oder . \' wird in der vorhandenen Gruppe \'. abgespielt, gefolgt vom Gruppennamen. Wenn Sie Hilfe benötigen, sagen Sie \ "Hilf mir \" . Also, bei was kann ich Ihnen helfen?</lang></voice>',
