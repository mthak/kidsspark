...
module.exports = {
    en: {
        translation: {
            ...
            CONSUMABLE_NOT_PURCHASED: '<voice name="Brian"><lang xml:lang="en-GB"> Sorry glide life line was not purchased at this time. You answered one question incorrectly, in order to proceed you need a glide life line, otherwise start a new game. To start the game please say, start new game.</lang></voice>',
            THANK_YOU_FOR_BUYING: '<voice name="Brian"><lang xml:lang="en-GB"> Thanks for buying glide life line . </lang></voice>',
            CAN_NOT_BUY_CONSUMABLE: '<voice name="Brian"><lang xml:lang="en-GB"> It looks like we are unable to sell hints right now.  Sorry.  Please try again or start a new game. To start the game please say, start new game.</lang></voice>',
    ...
    de: {
        translation: {
            ...
            CANNOT_BUY_RIGHT_NOW: '<voice name="Brian"><lang xml:lang="en-GB"> Ich glaube nicht, dass wir ein Produkt mit diesem Namen haben. Können Sie es erneut versuchen oder die aktuelle Frage beantworten? {currentQuestion}</lang></voice>',
            ...
            REASK_FIFTY_FIFTY_QUESTION: '<voice name="Brian"><lang xml:lang="en-GB">Sie haben Ihre beiden Optionen gehört. Lassen Sie uns versuchen, Ihre aktuelle Frage zu beantworten. {currentQuestion}</lang></voice>',
            REASK_EXPERT_REVIEW_QUESTION: '<voice name="Brian"><lang xml:lang="en-GB">Sie haben die Expertenkommentare gehört. Lassen Sie uns versuchen, Ihre aktuelle Frage zu beantworten. {currentQuestion}</lang></voice>',
            ...
            LIFE_LINE_MSG: '<voice name="Brian"><lang xml:lang="en-GB"> Du hast noch {{lifeLinesLeft}} Lebenslinien übrig. Bitte beantworten Sie Ihre aktuelle Frage, um fortzufahren, oder sagen Sie "Neues Spiel starten". Ihre aktuelle Frage lautet {currentQuestion}</lang></voice>',
            LIFE_LINE_EXHAUSTED: '<voice name="Brian"><lang xml:lang="en-GB"> Entschuldigung, Sie haben die Lebenslinie {{lifeLineName}} bereits verwendet. Bitte verwenden Sie eine andere Lebensader. Oder beantworten Sie Ihre aktuelle Frage. {currentQuestion}</lang></voice>',
            LIFE_LINES_SATUS: '<voice name="Brian"><lang xml:lang="en-GB"> Um über andere Lebenslinien Bescheid zu wissen, geben Sie meinen Lebenslinien- oder Lebenslinienstatus an. {currentQuestion}</lang></voice>',
            ...
            CONSUMABLE_NOT_PURCHASED: '<voice name="Brian"><lang xml:lang="en-GB"> Entschuldigung, Glide Life Line wurde zu diesem Zeitpunkt nicht gekauft. Sie haben eine Frage falsch beantwortet, um fortzufahren, benötigen Sie eine Gleit-Lebenslinie, andernfalls starten Sie ein neues Spiel. Um das Spiel zu starten, bitte neues Spiel starten. </lang></voice>',
            ...
            CAN_NOT_BUY_CONSUMABLE: '<voice name="Brian"><lang xml:lang="en-GB"> Anscheinend können wir derzeit keine Tipps verkaufen. Entschuldigung . Bitte versuche es erneut oder starte ein neues Spiel. Um das Spiel zu starten, bitte neues Spiel starten.</lang></voice>',
