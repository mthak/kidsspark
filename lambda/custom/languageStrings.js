...
module.exports = {
    en: {
        translation: {
            ...
            LIFE_LINE_MSG: '<voice name="Brian"><lang xml:lang="en-GB"> You have {{lifeLinesLeft}} life lines left. Please answer your current question to continue, or say start new game.</lang></voice>',
    ...
    de: {
        translation: {
            ...
            LIFE_LINE_MSG: '<voice name="Brian"><lang xml:lang="en-GB"> Du hast noch {{lifeLinesLeft}} Lebenslinien übrig. Bitte beantworten Sie Ihre aktuelle Frage, um fortzufahren, oder sagen Sie "Neues Spiel starten". </lang></voice>',
