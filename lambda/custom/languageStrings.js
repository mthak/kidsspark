...
module.exports = {
    en: {
        translation: {
            ...
            FALLBACK_MSG_ANSWER: '<voice name="Brian"><lang xml:lang="en-GB"> Sorry, I don\'t know about that. Please try again. If you are answering any question say, answer is, and then the answer.</lang></voice>',
            FALLBACK_MSG_QUESTION: '<voice name="Brian"><lang xml:lang="en-GB"> Sorry, I don\'t know about that. Please try again. To start and resume game please say start new game or resume game to begin playing. For help, say , Help me. So, What can I help you with?</lang></voice>',
    ...
    de: {
        translation: {
            ...
            FALLBACK_MSG_ANSWER: '<voice name="Marlene"><lang xml:lang="de-DE"> Entschuldigung, das weiß ich nicht. Bitte versuche es erneut. Wenn Sie eine Frage beantworten, sagen Sie, antworten Sie und dann die Antwort.</lang></voice>',
            FALLBACK_MSG_QUESTION: '<voice name="Marlene"><lang xml:lang="de-DE"> Entschuldigung, das weiß ich nicht. Bitte versuche es erneut. Zum Starten und Fortsetzen des Spiels sagen Sie bitte "Neues Spiel starten" oder "Spiel fortsetzen", um mit dem Spielen zu beginnen. Sagen Sie, um Hilfe zu erhalten, Helfen Sie mir. Also, womit kann ich Ihnen helfen?</lang></voice>',
